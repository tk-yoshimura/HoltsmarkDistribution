...
namespace HoltsmarkExpectedTest {
    ...
    public class PDFTest {
        ...
        public void Border10p4375Test() {
            ...
            Assert.IsTrue(PDFN16.Value(10.4375) == PDFNearZero<Pow2.N16, N24>.Value(10.4375));
            Assert.IsTrue(PDFN16.Value(10.4375) == PDFNearZero<Pow2.N16, Pow2.N32>.Value(10.4375));
        }
